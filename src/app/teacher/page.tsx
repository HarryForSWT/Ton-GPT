...
import { ChevronRight, Clock, CheckCircle2, Mic } from "lucide-react";
          ...
          <div className="space-y-3">
            {filtered.map((req) => (
              <Link
                ...
                className="block"
              >
                <div className={`p-4 bg-neutral-900 border rounded-2xl transition-all duration-200 group ${
                  req.status === "pending"
                    ? "border-amber-500/20 hover:border-blue-500/50"
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      {req.status === "reviewed" ? (
                        ...
                        <span className="flex items-center gap-1 px-2.5 py-1 bg-amber-500/15 text-amber-400 border border-amber-500/25 rounded-full text-xs font-bold">
                          <Clock size={11} />
                          {t.statusPending}
                        </span>
                      )}
